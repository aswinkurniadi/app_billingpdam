					...
					<div class="col-sm">
						<form action="<?= base_url('pelanggan/add'); ?>" method="post">
							<div class="form-group row">
								...
								<div class="col-sm-10">
								    <input type="number" class="form-control" id="no_plng" name="no_plng" placeholder="Nomor Pelanggan" autocomplete="off" value="<?= $no_plng; ?>" readonly="" required>
							    </div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
								    <input type="text" class="form-control" id="nm" name="nm" placeholder="Nama Pelanggan" autocomplete="off" required>
								</div>
							</div>
							<div class="form-group row">
								<label for="almt" class="col-sm-2 form-label">Alamat</label>
								<div class="col-sm-10">
								    <textarea class="form-control" id="almt" name="almt" cols="30" rows="5" placeholder="Alamat Pelanggan" required></textarea>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
								    <input type="number" class="form-control" id="nomor_air" name="nomor_air" placeholder="Nomor Air" autocomplete="off" required>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select class="form-control bootstrap-select" name="id_paket" class="form-control" title="Pilih Paket" data-live-search="true">
										<?php foreach ($dt_paket as $row) : ?>
											<option value="<?= $row['id_paket']; ?>"><?= $row['nama']; ?> ( <?= number_format($row['nilai']); ?> )</option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>

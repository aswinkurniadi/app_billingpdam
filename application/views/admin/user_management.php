...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
	    ...
	    <a href="" class="btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addDataUser" >
					...
					<div class="table-responsive">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td><?= $data['name']; ?></td>
						      <td><?php
						      foreach($dt_cabang as $row) {
						      	if($row['id_cabang'] == $data['id_cab']) {
						      		echo $row['nama'];
						      	}
						      } ?></td>
						      <td width="150px"><?php 
	...
	<div class="row">
		<div class="col-sm-6">
	  		<div class="card border-bottom-primary shadow mb-4">
	            <div class="card-header py-3">
	              <h6 class="m-0 font-weight-bold text-primary">Tabel Data User Role</h6>
	            </div>
				<div class="card-body">
					<div class="table-responsive">
				  		<table class="table table-user-management table-striped table-bordered table-sm" id="tabel-data">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td class="text-center">
						      		<a href="<?= base_url(); ?>admin/detail_access/<?= $data['id_role']; ?>" class="badge badge-success">
						      			<span class="icon text-white-50">
										  	<i class="fas fa-fw fa-edit"></i>
										</span>
										<span class="text">User Access</span>
									</a>
						      		<a href="<?= base_url(); ?>admin/delete_role/<?= $data['id_role']; ?>" class="badge badge-danger" onclick="return confirm('yakin?');">
						      			<span class="icon text-white-50">
										  	<i class="fas fa-fw fa-trash"></i>
										</span>
										<span class="text">Delete</span>

...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2025 at 04:33 PM
...
CREATE TABLE `piutang_in` (
  ...
  `plng_id` int(11) NOT NULL,
  `bln` int(11) NOT NULL,
  `nilai_meter` bigint(20) NOT NULL,
  `nilai_tagihan` bigint(20) NOT NULL,
...
INSERT INTO `piutang_in` (`id_piut`, `tgl`, `plng_id`, `bln`, `nilai_meter`, `nilai_tagihan`, `user_id`, `ket`, `date_created`) VALUES
(3, '2024-08-27', 6, 8, 0, 1200000, 7, 'tesss', '2025-10-02 22:25:39'),
(5, '2025-10-01', 1, 10, 0, 50000, 7, '', '2025-10-15 03:56:20');

-- --------------------------------------------------------

--
-- Table structure for table `piutang_in_detail`
--

CREATE TABLE `piutang_in_detail` (
  `id_piut_in_detail` int(11) NOT NULL,
  `id_piut_in` int(11) NOT NULL,
  `tgl` date NOT NULL,
  `stts` enum('utama','penyetaraan','subsidi','denda') NOT NULL,
  `nilai` bigint(20) NOT NULL,
  `date_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `piutang_in_detail`
--

INSERT INTO `piutang_in_detail` (`id_piut_in_detail`, `id_piut_in`, `tgl`, `stts`, `nilai`, `date_created`) VALUES
(5, 5, '2025-10-01', 'utama', 50000, '2025-10-15 03:56:20');
...
INSERT INTO `piutang_out` (`id_piut`, `tgl`, `id_piut_in`, `plng_id`, `bln`, `nilai`, `user_id`, `id_kas`, `dibayar`, `diterima`, `ket`, `date_created`) VALUES
(3, '2025-10-16', 5, 1, 10, 50000, 7, 1, 'tes', 'tes', 'tes', '2025-10-16 22:19:03');
...
--
-- Indexes for table `piutang_in_detail`
--
ALTER TABLE `piutang_in_detail`
  ADD PRIMARY KEY (`id_piut_in_detail`);
...
--
-- AUTO_INCREMENT for table `piutang_in_detail`
--
ALTER TABLE `piutang_in_detail`
  MODIFY `id_piut_in_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
